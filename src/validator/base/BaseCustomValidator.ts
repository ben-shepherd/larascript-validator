 ...
 */
export abstract class BaseCustomValidator<Attributes extends IValidatorAttributes = IValidatorAttributes> implements IValidator {
     ...
     */
    public async validate(data: Attributes, validator?: Validator): Promise<IValidatorResult<Attributes>> {
        // Reset the result
